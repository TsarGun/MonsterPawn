...
?>
<section class="page_breadcrumbs buttons_style cs main_color2 gradient lighten_gradient background_cover section_padding_top_75 section_padding_bottom_75" <?php echo function_exists( 'fw_get_db_customizer_option' ) ? 'style="background-image: ' . $background_image_url . '"' : ''; ?>>
	<div class="container">
		<div class="row">
