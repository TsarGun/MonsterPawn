...
$options = array(
	...
	'item_layout'        => array(
		...
		'type'    => 'select',
		'choices' => array(
			'vertical' => esc_html__( 'Vertical', 'cashelrie' ),
			''  => esc_html__( 'Horizontal', 'cashelrie' ),
		)
	),
	'layout'        => array(
		'label'   => esc_html__( 'Layout', 'cashelrie' ),
		'desc'    => esc_html__( 'Choose layout', 'cashelrie' ),
		'value'   => 'carousel',
		'type'    => 'select',
		'choices' => array(
	...
	'carousel_autoplay'  => array(
		'type'         => 'switch',
		'value'        => true,
		'label'        => esc_html__( 'Auto play carousel', 'cashelrie' ),
		'desc'         => esc_html__( 'Start sliding carousel automatically', 'cashelrie' ),
		'left-choice'  => array(
			'value' => false,
