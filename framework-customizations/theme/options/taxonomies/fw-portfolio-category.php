...
$options = array(
	'box_id' => array(
		'type'    => 'box',
		'title'   => esc_html__( 'Options for child categories', 'cashelrie' ),
		'options' => array(
			'layout'        => array(
			...
			'item_layout'   => array(
				...
				'type'    => 'select',
				'choices' => array(
					'item-regular'  => esc_html__( 'Regular (just image)', 'cashelrie' ),
			...
			'full_width'    => array(
				'type'         => 'switch',
				'value'        => false,
				'label'        => esc_html__( 'Full width gallery', 'cashelrie' ),
				'desc'         => esc_html__( 'Enable full width container for gallery', 'cashelrie' ),
				'left-choice'  => array(
					'value' => false,
